  ...
  <img src="photos\logo.png" height="40" alt="">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="/facultyh">Home</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="/facultyhome">View assignment</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/fviewquestion">View Question</a>
        </li>
